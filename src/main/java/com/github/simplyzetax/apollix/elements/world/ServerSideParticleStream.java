package com.github.simplyzetax.apollix.elements.world;
...
public class ServerSideParticleStream extends Element {

    public ServerSideParticleStream(UltraCustomizer ultraCustomizer) {
        super(ultraCustomizer);
    }

    @Override
    public String getName() {
        return "Server Sided Particle Stream";
    }
    ...
    public String[] getDescription() {
        return new String[]{"Creates a server sided particle stream"};
    }
    ...
    public void run(ElementInfo elementInfo, ScriptInstance scriptInstance) {
        try {
            ...
            world.spawnParticle(Particle.END_ROD, target, 5);
